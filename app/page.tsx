...
- [Comentário]`;
  ...
  if (guideOpen) return <main className="thrall-guide-page">
    ...
    <section className="guide-hero"><p className="eyebrow">THRALL + UNIRÁDIO · SÍNTESE APLICADA</p><h1>Entenda o sinal antes de concluir.</h1><p>Um roteiro prático para transformar a observação radiográfica em descrição, impressão e recomendação. Ele reúne princípios do Thrall com os materiais de técnica, trauma, ortopedia e raciocínio diferencial do seu acervo UniRádio.</p><div className="guide-stats"><span><b>{references.length}</b> fichas relacionadas</span><span><b>{thrallStudyGuides.length}</b> módulos de leitura</span><span><b>2</b> fontes de estudo integradas</span></div></section>
